	...
	public static void main(String[] args) {		
		...
		aaa : while(true)
		{
			...
			case 1:
				...
				//예시 추가
				mgr.addBook(new Book("55", "가나", "Alpha", "a.kr", 100, "aaaa"));
				mgr.addBook(new Magazine("66", "가나", "Delta", "e.kr", 50, "eeee", 2024, 8));
...
//				}
			...
			case 2: //title 기준으로 오름차순
				ArrayList<Book> list= mgr.getAllBook();
				
				//정렬하는 알고리즘은 Test에서 한다.
			...
			case 7: //잡지의 월을 기준으로 내림차순 정렬
				ArrayList<Book> returnList3 = mgr.magazineOfThisYearInfo(2024);
				
				//정렬하는 알고리즘은 Test에서 한다.
				Collections.sort(returnList3, new Comparator<Book>() {

					@Override
					public int compare(Book o1, Book o2) {
						return ((Magazine)o1).getMonth() - ((Magazine)o2).getMonth();
					}
