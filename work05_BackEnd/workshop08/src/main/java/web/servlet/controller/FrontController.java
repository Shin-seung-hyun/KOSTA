...
public class FrontController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(command.equals("registerBook"))path = registerBook(request, response);
		else if(command.equals("bookList")) path = bookList(request, response);
		else if(command.equals("search")) path = search(request, response);
		else if(command.equals("detail")) path = detail(request, response);
	...
	private String detail(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			Book vo = BookDAOImpl.getInstance().findBookbyIsbn(isbn);
