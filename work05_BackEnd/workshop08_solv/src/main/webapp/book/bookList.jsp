				...
				function() {
					...
					$.ajax({
						...
						success : function(result) {
							...
							$('#resultView').html(
									"<h3><font color=crimson>Book 상세정보 출력 :: "
											+ str[1] + " " + str[5] + " "
											+ str[6] + "</font></h3>");
						}//callback
					});
...
<body>
	...
	<table border="1">
		...
		<c:forEach items="${list}" var="book">
			<tr>
				...
				<td><span id="${book.isbn}" class="ajaxSubject"> <a
						href="#">${book.title}</a>
				</span></td>
	...
	<div class="center">
		<a href="./book/Book.html">도서 등록</a> <a href="${pageContext.request.contextPath}/front.do?command=bookList">도서 목록</a>
	</div>
</body>
</html>