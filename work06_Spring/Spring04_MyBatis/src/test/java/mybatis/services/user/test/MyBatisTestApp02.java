...
public class 	MyBatisTestApp02 {
	...
	public static void main(String[] args) throws Exception{
		...
		//==> mybatis-userservice-mapping02.xml : SQL 를 갖는 설정파일 (MetaData) 
		//
		...
		//				==> 검색결과 존재 확인 :: %와일드카드를 값에다 직접 입력 경우
		//				==> 원래는 쿼리문에서 와일드카드를 넣어야 한다.
		...
		//4. getUser :: 쿼리에 대입자를 이용한 like 연산자 검색==> 검색결과 존재 확인 
		...
		//6. getUser :: 쿼리에 대입자를 이용한 like 연산자 검색==> 검색결과 존재 확인 
		user.setUserId("01");
